...
import com.cucumber.framework.interfaces.webComponent;
...
public class GenericHelper implements webComponent {
	...
	public String takeScreenShot(String name) throws IOException {
		...
		File destDir = new File(("src/main/resources/screenshots")
